...
\in (0,1),$ and $\var(Y) =
v_2 \in (0,1)$. Note that we will have a non-linear system with four equations and four
...
and, then 
\begin{equation}
  \label{eq:alpha_3-expression}
  \alpha_3 = -\frac{\left((m_2-1)a_2 + m_2 - \frac{m_2^2v_1}{m_2v_1-m_1v_2}\right)}{\left((m_2-1)(a_3+1) + \frac{m_1m_2v_2}{m_2v_1-m_1v_2}\right)}\alpha_2 = -b_2\alpha_2.
\end{equation}

Therefore, we can write all the variables in function of $\alpha_2$:

\begin{align}
  \alpha_1 &= (a_2 - a_3b_2)\alpha_2 \\
  \alpha_3 &= - b_2\alpha_2 \\
  \alpha_4 &= -\frac{m_1v_2b_2 + m_2v_1}{m_2v_1 - m_1v_2}\alpha_2 \\
  a_2 &= \frac{1}{1-m_1}\left(m_1 - 1 - \frac{m_1m_2v_1}{m_2v_1 - m_1v_2}\right) \\
  a_3 &= \frac{1}{1-m_1}\left(m_1 + \frac{m_1^2v_2}{m_2v_1 - m_1v_2}\right) \\
  b_2 &=  \frac{\left((m_2-1)a_2 + m_2 - \frac{m_2^2v_1}{m_2v_1-m_1v_2}\right)}{\left((m_2-1)(a_3+1) + \frac{m_1m_2v_2}{m_2v_1-m_1v_2}\right)}.
\end{align}

With that expression, it is sufficient to solve 

$$
\frac{v_1}{m_1} = \frac{\alpha_3+\alpha_4}{\tilde{\alpha}(\tilde{\alpha+1})}.
$$

Define 
$$f(\alpha_2) = \frac{v_1}{m_1} -
\frac{\alpha_3+\alpha_4}{\tilde{\alpha}(\tilde{\alpha+1})}.$$ 

We want to find the root of $f$ such that $\alpha_2 > 0$. 
