...
\renewcommand{\imprimircapa}{%
	\begin{capa}%
	\center
		\ABNTEXchapterfont\Large \textbf{FUNDAÇÃO GETULIO VARGAS}
		\\\vspace*{2mm}
		\ABNTEXchapterfont\Large \textbf{ESCOLA de MATEMÁTICA APLICADA}
		\\\vspace*{4cm}
		{\ABNTEXchapterfont\large \textbf{LUCAS MACHADO MOSCHEN}}
		\vfill
		\begin{center}
