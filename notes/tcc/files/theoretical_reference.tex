...
\begin{alineas}
  ...
  \item {\em Successive sampling estimator:} Under the successive sampling
  approximation for RDS, \cite{gile2011improved} 
...
\cite{bastos2012binary}, \cite{avery2021statistical}, \cite{yauck2021general}.
