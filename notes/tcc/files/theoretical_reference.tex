...
The first appearance of the Conditionally autoregressive (CAR) models
\cite{besag1974spatial}, which formulated it with the objective of modelling
spatial interaction between a finite number of random variables representing
sites.  
