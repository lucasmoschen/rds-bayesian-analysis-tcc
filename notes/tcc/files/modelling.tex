...
\begin{table}[htbp]
  ...
  \begin{tabular}{ccccc}
    ...
    3   & (ER1, $P=0.005$)                & Standard                & 0.5    & 100      \\
    4   & (ER2, $P_1=0.008, P_2 = 0.002$) & Preferential($R = 0.5$) & 0.9995  & 100      \\
    5   & (BA1, $m = 25$)                 & Standard                & 0.9995  & 100      \\
    6   & (BA2, $P = 0.5, m = 25$)        & Preferential($R=0.5$)   & 0.9995  & 100      \\ \hline
  \end{tabular}
  \fonte{Prepared by the author (2021).}
\end{table}
...
previous experiment. In this experiment, the expected magnitude of $\omega$ is
...
$$
Because of that reason, we pick $\tau = 100$ for the next experiments. In this
case, notice that the posterior of $\rho$ in
\autoref{fig:posterior_parameters_rds_tau100} is very different from
...
$\rho$ is small as the third experiment. 
...
\begin{figure}
  ...
  for $\theta$, $\tau$ and $\rho$ for model \eqref{model:imperfect-tests-rds}
  when $\tau = 100$.}
