...
Now we are going to compare the three prior specification methods from 
three situations:

\begin{alineas}
  \item only vague information is available; 
  \item strong beliefs about the means and no information about correlation; 
  \item strong beliefs about the means and the correlation. 
\end{alineas}

\section{Imperfect tests}

A slight modification of model \eqref{model:perfect-tests} is to consider 
the imperfection of the test measured through specificity and sensibility, 
...
is an extension of model presented by \textcite{gelman2020bayesian}. 
