...
PC with Intel(R) Core(TM) i5-7200U 2.5GHz processor (4 cores) and 8 GB of memory.
...
\begin{figure}[!ht]
  ...
  \fonte{Prepared by the author (2021) and based on Stan and ArviZ outputs. The red line represents the true value
...
\begin{figure}[!ht]
  ...
  \fonte{Prepared by the author (2021) and based on Stan output. The green area is delimited by the curves generated
...
\begin{figure}[!ht]
  ...
  \fonte{Prepared by the author (2021) and based on Stan output.}
\end{figure}
...
\begin{figure}[!hb]
  ...
  \fonte{Prepared by the author (2021) and based on Stan output. The green area indicated the 95\%
...
\begin{figure}[ht]
  ...
  \caption{\label{fig:scatter_plot_posterior_imperfect_tests} Scatter plot of
    ...
    \eqref{model:imperfect-tests-rds}}
  \includegraphics[width=14.4cm]{scatter_plot_posterior_imperfect_tests.pdf}
...
The prior specification of $\rho$ is highly debated in the literature.
...
\begin{figure}[htb]
  ...
  \fonte{Prepared by the author (2021) and based on Stan and ArviZ outputs.
    The blue curve is the marginal distribution of the energy, while the red
...
\begin{figure}
  ...
  \caption{\label{fig:posterior_rds_imperfect_tests_exp1}Posterior distribution of
    ...
    \eqref{model:imperfect-tests-rds}.}
  \includegraphics[width=16cm]{posterior_rds_imperfect_tests_exp1.pdf}
...
\begin{figure}
  ...
  \includegraphics[width=7cm]{posterior_rds_imperfect_tests_exp1_rho.pdf}
  \fonte{Prepared by the author (2021) and based on Stan and ArviZ results.}
\end{figure}
...
\begin{figure}[htb]
  ...
  \includegraphics[width=16cm]{credible_intervals_effects_prev_comparison_rds_graphs.pdf}
...
\begin{figure}[htb]
  ...
  strong priors.}
  \includegraphics[width=16cm]{credible_intervals_effects_prev_comparison_rds_graphs_strong.pdf}
  \fonte{Prepared by the author (2021) ans based on Stan result.}
\end{figure}
...
As a validation of this method, with the same specifications of the experiment
...
intuitively, the credible intervals were not too broad. Therefore, well defined
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=12cm]{posteriors-including-uncertainty.pdf}
  \fonte{Prepared by the author (2021) and based on Stan and ArviZ results.}
\end{figure}
