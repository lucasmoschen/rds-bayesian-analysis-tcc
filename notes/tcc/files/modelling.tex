...
\begin{table}[htbp]
  ...
  1 & (ER1, $P=0.005$) & Standard & 0.9 & 1 \\
  2 & (ER1, $P=0.005$) & Standard & 0.9 & 10000 \\
  3 & (ER1, $P=0.005$) & Standard & 0.3 & 1 \\
  4 & (ER2, $P_1=0.008, P_2 = 0.002$) & Preferential($R = 0.5$) & 0.9 & 1 \\
  5 & (BA1, $m = 25$) & Standard & 0.9 & 1 \\
  6 & (BA2, $P = 0.5, m = 25$) & Preferential($R=0.5$) & 0.9 & 1 \\ \hline
  \end{tabular}
  \fonte{Prepared by the author (2021).}
  \end{table}
