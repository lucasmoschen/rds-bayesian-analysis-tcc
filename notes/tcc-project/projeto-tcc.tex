...
\preambulo{Bachelor dissertation project presented to the School of Applied Mathematics (EMAp/FGV) as a partial requirement for continuing the dissertation work. \\ \\
...
\input{files/justification.tex}

\chapter{Objectives}

\input{files/objectives.tex}
